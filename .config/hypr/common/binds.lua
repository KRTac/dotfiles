...
hl.bind("SUPER + comma", hl.dsp.window.resize({ x = -100, y = 0, relative = true }), { repeating = true })
hl.bind("SUPER + period", hl.dsp.window.resize({ x = 100, y = 0, relative = true }), { repeating = true })
hl.bind("SUPER + SHIFT + comma", hl.dsp.window.resize({ x = 0, y = -100, relative = true }), { repeating = true })
hl.bind("SUPER + SHIFT + period", hl.dsp.window.resize({ x = 0, y = 100, relative = true }), { repeating = true })
...
hl.bind("SUPER + Return", hl.dsp.exec_cmd("ghostty"), { description = "Ghostty Terminal" })
